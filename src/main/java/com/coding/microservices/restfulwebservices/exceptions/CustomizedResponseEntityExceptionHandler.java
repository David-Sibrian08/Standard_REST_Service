...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * @param ex The exception to be caught (in this case all of them, except the specific ones below)
     * @param request The request coming in
     * @return The custom Response that includes the response and the status code
     */
